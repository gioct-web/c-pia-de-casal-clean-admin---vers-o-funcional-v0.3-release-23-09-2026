...
CREATE TABLE `estimate_items` (
	...
	`service` enum('lavagem','impermeabilizacao','lavagem_impermeabilizacao') NOT NULL,
...
CREATE TABLE `estimates` (
	...
	`customerCity` varchar(160),
	`customerState` varchar(2),
	`scheduledAt` timestamp NOT NULL,
	`scheduleStatus` enum('scheduled','to_define') NOT NULL DEFAULT 'scheduled',
...
CREATE INDEX `estimates_identifier_idx` ON `estimates` (`id`);--> statement-breakpoint
